...
import type { VehicleWithHistory } from '@/lib/vehicleHistory'

interface VehicleDetailViewProps {
  vehicle: VehicleWithHistory
  currentUserId: string
  basePath: string
  nav: ComponentProps<typeof DashboardNav>
}

export function VehicleDetailView({ vehicle, currentUserId, basePath, nav }: VehicleDetailViewProps) {
  return (
      ...
      <main className="flex-1 pt-32 sm:pt-36">
        <div className="mx-auto flex w-full max-w-[900px] flex-col gap-8 px-4 sm:px-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Button asChild>
              <Link href={`${basePath}/history/new`}>
                Agregar registro
                <ButtonIconIsland>
